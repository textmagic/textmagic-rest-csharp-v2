...
namespace TextMagicClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "3.0.43912";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("textmagic client SDK C#");
        ...
        {
            string report = "C# SDK (TextMagicClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2\n";
            report += "    SDK Package Version: 3.0.43912\n";
