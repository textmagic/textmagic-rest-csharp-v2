...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReopenChatsBulkInputObject :  IEquatable<ReopenChatsBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReopenChatsBulkInputObject" /> class.
        /// </summary>
        /// <param name="ids">Entity ID(s), separated by comma.</param>
        /// <param name="all">Entity ID(s), separated by comma.</param>
        public ReopenChatsBulkInputObject(string ids = default(string), bool? all = default(bool?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as ReopenChatsBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ReopenChatsBulkInputObject input)
        {
            if (input == null)
                return false;
