...
namespace TextMagicClient.Model
{
    ...
    public partial class SendPhoneVerificationCodeTFAInputObject :  IEquatable<SendPhoneVerificationCodeTFAInputObject>, IValidatableObject
    {
        ...
        public SendPhoneVerificationCodeTFAInputObject(string phone = default(string), string brand = default(string), int? codeLength = default(int?), string language = default(string), string senderId = default(string), string country = default(string))
        {
            this.Phone = phone;
            this.Brand = brand;
