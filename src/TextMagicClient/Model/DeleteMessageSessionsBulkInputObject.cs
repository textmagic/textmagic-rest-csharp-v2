...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteMessageSessionsBulkInputObject :  IEquatable<DeleteMessageSessionsBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteMessageSessionsBulkInputObject" /> class.
        /// </summary>
        ...
        public DeleteMessageSessionsBulkInputObject(string ids = default(string), int? all = default(int?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as DeleteMessageSessionsBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteMessageSessionsBulkInputObject input)
        {
            if (input == null)
                return false;
