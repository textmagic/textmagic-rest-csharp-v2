...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchInboundMessagesPaginatedResponse")]
    public partial class SearchInboundMessagesPaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        public SearchInboundMessagesPaginatedResponse(int page = default, int pageCount = default, int limit = default, List<MessageIn> resources = default)
        {
            this.Page = page;
            ...
            if (resources == null)
            {
                throw new ArgumentNullException("resources is a required property for SearchInboundMessagesPaginatedResponse and cannot be null");
            }
