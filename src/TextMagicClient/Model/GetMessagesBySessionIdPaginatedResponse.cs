...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetMessagesBySessionIdPaginatedResponse")]
    public partial class GetMessagesBySessionIdPaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetMessagesBySessionIdPaginatedResponse(int page = default, int pageCount = default, int limit = default, List<MessageOut> resources = default)
        {
            this.Page = page;
            ...
            if (resources == null)
            {
                throw new ArgumentNullException("resources is a required property for GetMessagesBySessionIdPaginatedResponse and cannot be null");
            }
