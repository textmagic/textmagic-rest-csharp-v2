...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteOutboundMessagesBulkInputObject :  IEquatable<DeleteOutboundMessagesBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteOutboundMessagesBulkInputObject" /> class.
        /// </summary>
        ...
        public DeleteOutboundMessagesBulkInputObject(string ids = default(string), int? all = default(int?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as DeleteOutboundMessagesBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteOutboundMessagesBulkInputObject input)
        {
            if (input == null)
                return false;
