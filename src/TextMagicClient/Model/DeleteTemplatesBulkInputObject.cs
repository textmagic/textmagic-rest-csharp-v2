...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteTemplatesBulkInputObject :  IEquatable<DeleteTemplatesBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteTemplatesBulkInputObject" /> class.
        /// </summary>
        /// <param name="ids">Entity ID(s), separated by comma..</param>
        /// <param name="all">Entity ID(s), separated by comma..</param>
        public DeleteTemplatesBulkInputObject(string ids = default(string), bool? all = default(bool?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as DeleteTemplatesBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteTemplatesBulkInputObject input)
        {
            if (input == null)
                return false;
