...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarkChatsUnreadBulkInputObject :  IEquatable<MarkChatsUnreadBulkInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MarkChatsUnreadBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(MarkChatsUnreadBulkInputObject input)
        {
            if (input == null)
                return false;
