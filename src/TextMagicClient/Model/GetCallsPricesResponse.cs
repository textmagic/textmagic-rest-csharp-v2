...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCallsPricesResponse")]
    public partial class GetCallsPricesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetCallsPricesResponse(decimal outbound = default, decimal inbound = default, decimal forward = default, string country = default)
        {
            ...
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for GetCallsPricesResponse and cannot be null");
            }
