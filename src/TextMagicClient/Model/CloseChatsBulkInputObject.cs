...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloseChatsBulkInputObject :  IEquatable<CloseChatsBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseChatsBulkInputObject" /> class.
        /// </summary>
        /// <param name="ids">Entity ID(s), separated by comma..</param>
        /// <param name="all">Entity ID(s), separated by comma..</param>
        public CloseChatsBulkInputObject(string ids = default(string), bool? all = default(bool?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as CloseChatsBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CloseChatsBulkInputObject input)
        {
            if (input == null)
                return false;
