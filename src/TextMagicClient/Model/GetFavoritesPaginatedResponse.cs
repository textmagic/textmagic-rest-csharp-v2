...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFavoritesPaginatedResponse")]
    public partial class GetFavoritesPaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetFavoritesPaginatedResponse(int page = default, int pageCount = default, int limit = default, List<FavoriteContact> resources = default)
        {
            this.Page = page;
            ...
            if (resources == null)
            {
                throw new ArgumentNullException("resources is a required property for GetFavoritesPaginatedResponse and cannot be null");
            }
        ...
        */
        ...
        public List<FavoriteContact> Resources { get; set; }
