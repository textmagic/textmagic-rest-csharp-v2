...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateTemplateInputObject :  IEquatable<CreateTemplateInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateTemplateInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateTemplateInputObject input)
        {
            if (input == null)
                return false;
