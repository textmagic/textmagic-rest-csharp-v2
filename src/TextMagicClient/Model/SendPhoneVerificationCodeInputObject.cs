...
namespace TextMagicClient.Model
{
    ...
    public partial class SendPhoneVerificationCodeInputObject :  IEquatable<SendPhoneVerificationCodeInputObject>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SendPhoneVerificationCodeInputObject" /> class.
        /// </summary>
        /// <param name="phone">Use the phone number in international E.164 format. If you need to pass a phone number in the local format, please use it with the **country** parameter to specify the origin country of the phone number.  (required).</param>
        /// <param name="brand">An alphanumeric string with up to 18 characters you can use to personalize the verification text message body, to help users identify your company or application name. For example: “Your TextMagic PIN is …”  (required).</param>
