...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteInboundMessagesBulkInputObject :  IEquatable<DeleteInboundMessagesBulkInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeleteInboundMessagesBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DeleteInboundMessagesBulkInputObject input)
        {
            if (input == null)
                return false;
