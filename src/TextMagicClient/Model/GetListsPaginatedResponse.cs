...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetListsPaginatedResponse")]
    public partial class GetListsPaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetListsPaginatedResponse(int page = default, int pageCount = default, int limit = default, List<List> resources = default)
        {
            this.Page = page;
            ...
            if (resources == null)
            {
                throw new ArgumentNullException("resources is a required property for GetListsPaginatedResponse and cannot be null");
            }
