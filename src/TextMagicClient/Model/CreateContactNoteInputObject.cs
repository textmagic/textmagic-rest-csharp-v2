...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateContactNoteInputObject :  IEquatable<CreateContactNoteInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateContactNoteInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateContactNoteInputObject input)
        {
            if (input == null)
                return false;
