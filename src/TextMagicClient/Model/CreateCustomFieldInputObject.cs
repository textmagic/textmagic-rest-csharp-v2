...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCustomFieldInputObject :  IEquatable<CreateCustomFieldInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateCustomFieldInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateCustomFieldInputObject input)
        {
            if (input == null)
                return false;
