...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnblockContactsBulkInputObject :  IEquatable<UnblockContactsBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnblockContactsBulkInputObject" /> class.
        /// </summary>
        ...
        public UnblockContactsBulkInputObject(string ids = default(string), int? all = default(int?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as UnblockContactsBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(UnblockContactsBulkInputObject input)
        {
            if (input == null)
                return false;
