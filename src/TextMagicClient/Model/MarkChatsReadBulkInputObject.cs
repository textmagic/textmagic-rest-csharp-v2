...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarkChatsReadBulkInputObject :  IEquatable<MarkChatsReadBulkInputObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkChatsReadBulkInputObject" /> class.
        /// </summary>
        /// <param name="ids">Entity ID(s), separated by comma..</param>
        /// <param name="all">Entity ID(s), separated by comma..</param>
        public MarkChatsReadBulkInputObject(string ids = default(string), bool? all = default(bool?))
        {
            this.Ids = ids;
            this.All = all;
        }
        ...
        {
            return this.Equals(input as MarkChatsReadBulkInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(MarkChatsReadBulkInputObject input)
        {
            if (input == null)
                return false;
