...
namespace TextMagicClient.Model
{
    ...
    public partial class GetVersionsResponse :  IEquatable<GetVersionsResponse>, IValidatableObject
    {
        ...
        public GetVersionsResponse(string ios = default(string), string android = default(string), string desktop = default(string))
        {
            // to ensure "ios" is required (not null)
            if (ios == null)
            {
                throw new InvalidDataException("ios is a required property for GetVersionsResponse and cannot be null");
            }
            else
            {
                this.Ios = ios;
            ...
            if (android == null)
            {
                throw new InvalidDataException("android is a required property for GetVersionsResponse and cannot be null");
            }
            else
            {
            ...
            if (desktop == null)
            {
                throw new InvalidDataException("desktop is a required property for GetVersionsResponse and cannot be null");
            }
            else
            {
