...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAllInboundMessagesPaginatedResponse")]
    public partial class GetAllInboundMessagesPaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetAllInboundMessagesPaginatedResponse(int page = default, int pageCount = default, int limit = default, List<MessageIn> resources = default)
        {
            this.Page = page;
            ...
            if (resources == null)
            {
                throw new ArgumentNullException("resources is a required property for GetAllInboundMessagesPaginatedResponse and cannot be null");
            }
