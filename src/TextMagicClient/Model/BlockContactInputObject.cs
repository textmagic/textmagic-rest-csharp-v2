...
namespace TextMagicClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlockContactInputObject :  IEquatable<BlockContactInputObject>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BlockContactInputObject);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BlockContactInputObject input)
        {
            if (input == null)
                return false;
