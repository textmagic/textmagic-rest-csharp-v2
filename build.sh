...
${nuget_cmd} install src/TextMagicClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TextMagicClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TextMagicClient.dll \
-recurse:'src/TextMagicClient/*.cs' \
-doc:bin/TextMagicClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TextMagicClient.dll was created successfully"
fi
